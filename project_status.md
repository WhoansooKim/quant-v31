...
- **Open Positions**: 0개 (전량 청산 상태, 하락장 진입 차단 정상 동작)
...
max_positions            = 10         ← 백테스트 검증: 분산 투자 (2026-03-25 변경)
max_daily_entries        = 2
position_pct             = 0.10 (10%) ← 10종목 × 10% = 100% (2026-03-25 변경)
